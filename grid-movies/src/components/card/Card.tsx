...
const Card = ({ title, poster, releaseDate, rating }: TCardProps) => {
    return (
        <div className='relative rounded-md'>
            <div className='w-12 h-8 flex justify-center items-center absolute top-0 right-0 bg-yellow text-gray-darkest rounded-bl-md rounded-tr-md z-30'>{rating.toFixed(1)}</div>
